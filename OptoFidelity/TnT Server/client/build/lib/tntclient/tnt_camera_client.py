...
class TnTCameraClient(TnTClientObject):
    ...
    def read_text(self, context='tnt', language='English', detector='abbyy', exposure=None, gain=None, parameters=None):    
        """
        DEPRECATED!
    ...
    def screenshot(self, crop_left=None, crop_upper=None, crop_right=None, crop_lower=None, crop_unit=None, exposure=None, gain=None, duration=None):    
        """
